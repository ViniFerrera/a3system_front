			...
			<div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
				...
				<Card className='lg:col-span-2 p-6 min-h-[400px] relative overflow-hidden'>
					...
					{isChatLoading ? (
						...
						<div className='prose prose-sm prose-indigo max-w-none text-slate-600 bg-white/50 p-4 rounded-xl border border-slate-100 shadow-sm'>
							{/* Renderização simples de quebras de linha. 
                                Para Markdown completo, poderia usar react-markdown */}
							{chatResponse.split("\n").map((line, i) => (
